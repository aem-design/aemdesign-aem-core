...
//
//        // Run the test
//        final String result = commonUtilUnderTest.toJson(object);
//
//        // Verify the results
...
//
//        // Run the test
//        final String result = CommonUtil.escapeBody(body);
//
//        // Verify the results
//        assertEquals(expectedResult, result);
//    }
//
//    @Test
//    public void testGetPageRedirect() {
//        // Setup
//        final Page page = null;
//        final String expectedResult = "result";
//
//        // Run the test
//        final String result = CommonUtil.getPageRedirect(page);
//
//        // Verify the results
//        assertEquals(expectedResult, result);
//    }
...
//
//        // Run the test
//        final String result = CommonUtil.getPageUrl(page);
//
//        // Verify the results
//        assertEquals(expectedResult, result);
//    }
...
//
//        // Run the test
//        final Long result = CommonUtil.getLastModified(resource);
//
//        // Verify the results
//        assertEquals(expectedResult, result);
//    }
...
//
//        // Run the test
//        final String result = CommonUtil.getPageTitle(page, resourceResolver);
//
//        // Verify the results
//        assertEquals(expectedResult, result);
//    }
//
//    @Test
//    public void testGetPageTitle1() {
//        // Setup
//        final Page page = null;
//        final ResourceResolver resourceResolver = null;
//        final String[] componentNames = new String[]{};
//        final String expectedResult = "result";
//
//        // Run the test
//        final String result = CommonUtil.getPageTitle(page, resourceResolver, componentNames);
//
//        // Verify the results
//        assertEquals(expectedResult, result);
//    }
//
//    @Test
//    public void testGetPageTitle2() {
//        // Setup
//        final Page page = null;
//        final Resource detailsComponent = null;
//        final String expectedResult = "result";
//
//        // Run the test
//        final String result = CommonUtil.getPageTitle(page, detailsComponent);
//
//        // Verify the results
//        assertEquals(expectedResult, result);
//    }
//
//    @Test
//    public void testGetPageTitle3() {
//        // Setup
//        final Page page = null;
//        final String expectedResult = "result";
//
//        // Run the test
//        final String result = CommonUtil.getPageTitle(page);
//
//        // Verify the results
//        assertEquals(expectedResult, result);
//    }
//
//    @Test
//    public void testGetPageTitle4() {
//        // Setup
//        final Page page = null;
//        final String defaultTitle = "defaultTitle";
//        final String expectedResult = "result";
//
//        // Run the test
//        final String result = CommonUtil.getPageTitle(page, defaultTitle);
//
//        // Verify the results
//        assertEquals(expectedResult, result);
//    }
//
//    @Test
//    public void testGetPageNavTitle() {
//        // Setup
//        final Page page = null;
//        final String expectedResult = "result";
//
//        // Run the test
//        final String result = CommonUtil.getPageNavTitle(page);
//
//        // Verify the results
//        assertEquals(expectedResult, result);
//    }
//
//    @Test
//    public void testGetPageContentTypeTag() {
//        // Setup
//        final Page page = null;
//        final String[] expectedResult = new String[]{};
//
//        // Run the test
//        final String[] result = CommonUtil.getPageContentTypeTag(page);
//
//        // Verify the results
...
//        // Setup
//        final Page page = null;
//        final Image expectedResult = null;
//
//        // Run the test
//        final Image result = CommonUtil.getPageImage(page);
//
//        // Verify the results
//        assertEquals(expectedResult, result);
//    }
...
//
//        // Run the test
//        final String result = CommonUtil.getProperty(node, property);
//
//        // Verify the results
//        assertEquals(expectedResult, result);
//    }
...
//    public void testGetProperty_ThrowsRepositoryException() throws Exception {
//        // Setup
//        final Node node = null;
//        final String property = "property";
//
//        // Run the test
//        CommonUtil.getProperty(node, property);
//    }
//
//    @Test
...
//
//        // Run the test
//        final String result = CommonUtil.getPropertyWithDefault(node, property, defaultValue);
//
//        // Verify the results
//        assertEquals(expectedResult, result);
//    }
//
//    @Test(expected = RepositoryException.class)
//    public void testGetPropertyWithDefault_ThrowsRepositoryException() throws Exception {
//        // Setup
//        final Node node = null;
//        final String property = "property";
//        final String defaultValue = "defaultValue";
//
//        // Run the test
//        CommonUtil.getPropertyWithDefault(node, property, defaultValue);
//    }
//
//    @Test
//    public void testGetMultiResultPropertyWithDefault() throws Exception {
//        // Setup
//        final Node node = null;
//        final String property = "property";
//        final String defaultValue = "defaultValue";
...
//
//        // Run the test
//        final String result = CommonUtil.getMultiResultPropertyWithDefault(node, property, defaultValue);
//
//        // Verify the results
//        assertEquals(expectedResult, result);
//    }
//
//    @Test(expected = RepositoryException.class)
//    public void testGetMultiResultPropertyWithDefault_ThrowsRepositoryException() throws Exception {
//        // Setup
//        final Node node = null;
//        final String property = "property";
//        final String defaultValue = "defaultValue";
//
//        // Run the test
//        CommonUtil.getMultiResultPropertyWithDefault(node, property, defaultValue);
//    }
//
//    @Test
//    public void testEscapeUrl() {
//        // Setup
//        final String unencoded = "unencoded";
//        final String expectedResult = "result";
//
//        // Run the test
//        final String result = CommonUtil.escapeUrl(unencoded);
//
//        // Verify the results
//        assertEquals(expectedResult, result);
//    }
...
//        // Setup
//        final String jcrSql = "jcrSql";
//        final String expectedResult = "result";
//
//        // Run the test
//        final String result = CommonUtil.escapeJcrSql(jcrSql);
//
//        // Verify the results
//        assertEquals(expectedResult, result);
//    }
...
//
//        // Run the test
//        final String result = CommonUtil.getLastItem(array);
//
//        // Verify the results
//        assertEquals(expectedResult, result);
//    }
//
//    @Test
//    public void testGetBadgeBase() throws Exception {
//        // Setup
...
//
//        // Run the test
//        final String result = CommonUtil.getBadgeBase(pageManager, resourceResolver, resourcePath);
//
//        // Verify the results
//        assertEquals(expectedResult, result);
//    }
//
//    @Test(expected = RepositoryException.class)
//    public void testGetBadgeBase_ThrowsRepositoryException() throws Exception {
//        // Setup
//        final PageManager pageManager = null;
//        final ResourceResolver resourceResolver = null;
//        final String resourcePath = "resourcePath";
//
//        // Run the test
//        CommonUtil.getBadgeBase(pageManager, resourceResolver, resourcePath);
//    }
//
//    @Test
//    public void testGetBadgesForPaths() {
//        // Setup
//        final ResourceResolver resolver = null;
//        final String variant = "variant";
//        final String[] paths = new String[]{};
//        final ArrayList<HashMap> expectedResult = new ArrayList<>(Arrays.asList());
//
//        // Run the test
//        final ArrayList<HashMap> result = CommonUtil.getBadgesForPaths(resolver, variant, paths);
//
//        // Verify the results
//        assertEquals(expectedResult, result);
//    }
//
//    @Test
//    public void testGetAssetBadgeBase() {
//        // Setup
//        final Resource resource = null;
//        final String expectedResult = "result";
//
//        // Run the test
//        final String result = CommonUtil.getAssetBadgeBase(resource);
//
//        // Verify the results
//        assertEquals(expectedResult, result);
//    }
//
//    @Test
//    public void testScanPageForDetails() throws Exception {
//        // Setup
//        final TagManager tagManager = null;
//        final Page inputPage = null;
//        final HttpServletRequest request = null;
//
//        // Run the test
//        final boolean result = CommonUtil.scanPageForDetails(tagManager, inputPage, request);
//
//        // Verify the results
//        assertTrue(result);
//    }
//
//    @Test(expected = RepositoryException.class)
//    public void testScanPageForDetails_ThrowsRepositoryException() throws Exception {
//        // Setup
//        final TagManager tagManager = null;
//        final Page inputPage = null;
//        final HttpServletRequest request = null;
//
//        // Run the test
//        CommonUtil.scanPageForDetails(tagManager, inputPage, request);
//    }
//
//    @Test
//    public void testSetDetailRequestParams() {
//        // Setup
//        final HttpServletRequest request = null;
//        final String resourceType = "resourceType";
//        final String[] shareTags = new String[]{};
//
//        // Run the test
//        final boolean result = CommonUtil.setDetailRequestParams(request, resourceType, shareTags);
//
//        // Verify the results
//        assertTrue(result);
//    }
//
//    @Test
//    public void testGetPageBadgeBase() throws Exception {
//        // Setup
//        final Page inputPage = null;
...
//
//        // Run the test
//        final String result = CommonUtil.getPageBadgeBase(inputPage, useDefault);
//
//        // Verify the results
//        assertEquals(expectedResult, result);
//    }
//
//    @Test(expected = RepositoryException.class)
//    public void testGetPageBadgeBase_ThrowsRepositoryException() throws Exception {
//        // Setup
//        final Page inputPage = null;
//        final boolean useDefault = false;
//
//        // Run the test
//        CommonUtil.getPageBadgeBase(testResourcePage, useDefault);
//    }
