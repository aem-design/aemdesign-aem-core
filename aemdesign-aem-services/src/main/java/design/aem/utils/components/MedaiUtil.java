...
public class MedaiUtil {
    ...
    public static final String PLAYER_ADDRESS = "/etc.clientlibs/aemdesign/clientlibs/core/vendorlib/flash/player.swf";
    public static final String GALLERIA_THEME = "/etc.clientlibs/aemdesign/clientlibs/core/vendorlib/galleria/classic/galleria.classic.min.js";
