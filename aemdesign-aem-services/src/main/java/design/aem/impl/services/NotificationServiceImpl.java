...
//                    log.error("Could not fetch authorizable: " + recipientId, e);
//                }
//            } catch (Exception ex) {
...
//                } catch(RepositoryException e) {
//                    log.error("Could not fetch authorizable properties", e);
//                    return;
//                }
//
//                if (properties != null) {
...
//                    log.error("Notification workflow error " + workflowModelPath, e);
//                }
//            }
//        } catch (RepositoryException e) {
//            log.error("Could not fetch e-mail targets", e);
//        }
//
//    }
//}
