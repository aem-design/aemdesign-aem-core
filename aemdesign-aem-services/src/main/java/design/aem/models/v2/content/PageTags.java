...
public class PageTags extends WCMUsePojo {
    ...
    public void activate() throws Exception {
        ...
        componentProperties.put("pagetags", getTagsAsAdmin(getSlingScriptHelper(), getCurrentPage().getProperties().get(TagConstants.PN_TAGS,new String[]{}), getRequest().getLocale()));
