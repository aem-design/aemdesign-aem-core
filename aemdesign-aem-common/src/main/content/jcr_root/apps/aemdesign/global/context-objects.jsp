...
<%
    ...
    java.util.ResourceBundle _resourceBundle = _slingRequest.getResourceBundle(_currentPage.getLanguage(true));
    com.day.cq.i18n.I18n _i18n = new com.day.cq.i18n.I18n(_resourceBundle);
