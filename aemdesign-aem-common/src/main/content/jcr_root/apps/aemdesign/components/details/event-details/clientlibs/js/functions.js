...
window.AEMDESIGN.components.authoring.eventdetails = AEMDESIGN.components.authoring.eventdetails || {};
...
(function ($, $document, Coral, ns, window, undefined) { //NOSONAR convention for wrapping all modules
    ...
    ns.getExternalizeUrl = function() {
        $.ajax({
            ...
            console.log(["dialog-eventdetails-functions","getExternalizeUrl",ns.authorUrl,ns.publishUrl]);
    ...
    console.log(["dialog-eventdetails-functions","loaded"]);


})($, $(document), Coral, AEMDESIGN.components.authoring.eventdetails, this); //pass in additional dependencies
