<div ${componentProperties.componentAttributes}>
    <form action="${componentProperties.formAction}" method="${componentProperties.formMethod}" novalidate="" role="form search">
        <fieldset>
            ...
            <input autocomplete="off" id="nav_search" name="${componentProperties.formParameterName}" placeholder="${componentProperties.placeholderText}" type="search"> <input type="submit" value="${componentProperties.searchButtonText}">
        </fieldset>
    </form>
</div>