...
List Nav component allows you to add Previous and Next navigation buttons to a page that allows navigation from one article to another.  

# Overview

User for creating Previous and Next navigation on a page based on specified search criteria
...
* **Source**: [gitlab/aemdesign](https://gitlab.com/aem.design/aemdesign-aem-common/tree/master/src/main/content/jcr_root/apps/aemdesign/components/lists/listnav/v2/listnav)
