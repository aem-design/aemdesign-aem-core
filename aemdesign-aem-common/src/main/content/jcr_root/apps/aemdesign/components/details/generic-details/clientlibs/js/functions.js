...
(function ($, $document, Coral, ns, window, undefined) { //NOSONAR convention for wrapping all modules
  ...
  ns.getExternalizeUrl = function () {
    $.ajax({
      ...
      console.log(["dialog-genericdetails-functions", "getExternalizeUrl", ns.authorUrl, ns.publishUrl]);
  ...
  console.log(["dialog-genericdetails-functions", "loaded"]);
