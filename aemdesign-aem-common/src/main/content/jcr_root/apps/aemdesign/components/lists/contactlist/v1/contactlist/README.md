...
Event List component used to create list of event articles. 
...
* **Showcase**: [/content/aemdesign-showcase/en/component/lists/eventlist/v1/eventlist](/content/aemdesign-showcase/en/component/lists/newslist.html?wcmmode=disabled)
* **Local Code**: [/apps/aemdesign/components/lists/eventlist/v1/eventlist](/crx/de/#/apps/aemdesign/components/lists/eventlist/v1/eventlist)
* **Source**: [gitlab/aemdesign](https://gitlab.com/aem.design/aemdesign-aem-common/tree/master/src/main/content/jcr_root/apps/aemdesign/components/lists/eventlist/v1/eventlist)
* **Readme**: [/apps/aemdesign/components/lists/eventlist/v1/eventlist](/mnt/overlay/wcm/core/content/sites/components/details.html/apps/aemdesign/components/lists/eventlist/v1/eventlist)
