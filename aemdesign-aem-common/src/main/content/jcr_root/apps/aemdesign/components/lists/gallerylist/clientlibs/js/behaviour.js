...
window.AEMDESIGN.components.gallery = AEMDESIGN.components.gallery || {};
...
(function($,_,ko, ns, window, undefined) {
    ...
    $(document).ready(function() {
        ...
        //         },
        //         afterShow: function() {
        //             ns.generateGalleryCaption(this.captionData);
        //         }
        //     }).each(function () {
        //         ns.generateGalleryRollover($(this));
        //     });
        //
        //     //$container.isotope({
...
})(AEMDESIGN.jQuery,_,ko, AEMDESIGN.components.gallery, this);