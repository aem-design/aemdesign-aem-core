...
(function ($, ns, http, log, window, undefined) {
    ...
    ns.PostRequest.prototype.prepareCreateNode = function (primaryType, resourceType, templatePath, extraParams, nameHint, isChildNode) {
        if (!isChildNode) {
            return (
                this
            ...
            var childNode = new ns.PostRequest().prepareCreateNode(primaryType, resourceType, templatePath, extraParams, "", false)
                .setJcrPrimaryTypeParam(primaryType)
                .setSlingResTypeParam(resourceType)
                .setCqTemplatePathParam(templatePath)
                .setParams(extraParams);
